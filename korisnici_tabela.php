<?php 
  ...
  if(isset($_POST['subBtn'])){
    ...
    $sql = "INSERT INTO korisnici (id, ime, prezime) VALUES (NULL, '$ime', '$prezime')";
...
<html lang="en">
  ...
  <body>
    ...
    <a href="instrumenti_tabela.php" button type="button" class="btn btn-warning">Vidi instrumente</button>
